...
Route management service for the GoPaaS platform.
...
make build
```
This will generate a route binary file

### 3. Build Docker image
```bash
make docker
```
This will automatically generate a route:latest image
You can verify with: `docker images | grep route`
