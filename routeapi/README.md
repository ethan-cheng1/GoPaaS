...
Route management API for the GoPaaS platform.
...
make build
```
This will generate a routeApi binary file

### 3. Build Docker image
```bash
make docker
```
This will automatically generate a routeApi:latest image
You can verify with: `docker images | grep routeApi`
